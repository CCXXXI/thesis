...
Logging包除 @ALL@ 和 @OFF@ 外，提供了8个日志等级，从高到低分别为 @SHOUT@、@SEVERE@、@WARNING@、@INFO@、@CONFIG@、@FINE@、@FINER@、@FINEST@。在应用中，日志等级的使用遵循如表~\ref{tab:log-levels} 所示的规则。

\begin{table}[ht]
    \centering
    \bicaption{日志等级}{Log levels}\label{tab:log-levels}
