...
\subsubsection{心电图部分的界面实现}\label{subsubsec:history-ecg-design}
...
\subsubsection{时间选择器部分的界面实现}\label{subsubsec:history-time-picker-design}
...
\subsubsection{时间范围选择器部分的界面实现}\label{subsubsec:analytics-time-range-design}
...
\begin{figure}[ht]
    \centering
    \subcaptionbox{Android}{\includegraphics[height=13cm]{../assets/settings}}
    \subcaptionbox{iOS}{\includegraphics[height=13cm]{../assets/ios-settings}}
