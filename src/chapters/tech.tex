...
Flutter并不是唯一一个支持Android和iOS平台的跨平台应用程序开发框架。在本项目的选型过程中也考虑了其他几个经常被与Flutter进行比较的同类框架，包括React Native\cite{ReactNative2023}、Xamarin\cite{XamarinForms2023}、Ionic Creator\cite{IonicFrameworkCrossPlatform}。
