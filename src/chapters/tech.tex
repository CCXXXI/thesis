...
PyQtDeploy\cite{limitedPyqtdeployPyQtApplication}、QPython\cite{QPython2023}、Termux\cite{TermuxApplication2023}等工具可以用于在移动端执行Python代码，但未提供可供Java、Dart等语言调用的接口，因此无法在本项目中使用。
