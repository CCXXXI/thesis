...
\begin{figure}[ht]
    \subcaptionbox{陈桂琛的程序\cite{chenJiyushenduxuexidexindianfenximoxingdeshejiyuyouhua2021}}{\includegraphics[height=9cm]{../assets/demo-0}}
    \subcaptionbox{刘荟的程序\cite{liuJiyuyidongzhongduanfenxidekechuandairouxingxindianjiancexitong2021}}{\includegraphics[height=9cm]{../assets/demo-1}}
