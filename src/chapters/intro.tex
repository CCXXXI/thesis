...
\begin{figure}[ht]
    \subcaptionbox{\cite{chenJiyushenduxuexidexindianfenximoxingdeshejiyuyouhua2021}\label{fig:demo-0}}{\includegraphics[height=9cm]{../assets/demo-0}}
    \subcaptionbox{\cite{liuJiyuyidongzhongduanfenxidekechuandairouxingxindianjiancexitong2021}\label{fig:demo-1}}{\includegraphics[height=9cm]{../assets/demo-1}}
    \subcaptionbox{\cite{jinPredictingCardiovascularDisease2009}\label{fig:demo-2}}{\includegraphics[height=9cm]{../assets/demo-2}}
