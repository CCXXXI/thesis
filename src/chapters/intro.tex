...
\begin{figure}[ht]
    \subcaptionbox{\cite{chenJiyushenduxuexidexindianfenximoxingdeshejiyuyouhua2021}}{\includegraphics[height=9cm]{../assets/demo-0}}
    \subcaptionbox{\cite{liuJiyuyidongzhongduanfenxidekechuandairouxingxindianjiancexitong2021}}{\includegraphics[height=9cm]{../assets/demo-1}}
    \subcaptionbox{\cite{jinPredictingCardiovascularDisease2009}}{\includegraphics[height=9cm]{../assets/demo-2}}
