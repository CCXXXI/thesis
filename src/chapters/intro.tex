...
\begin{figure}[h]
    \subcaptionbox{\label{fig:demo-0}}{\includegraphics[height=9cm]{../assets/demo-0}}
    \subcaptionbox{\label{fig:demo-1}}{\includegraphics[height=9cm]{../assets/demo-1}}
    \subcaptionbox{\label{fig:demo-2}}{\includegraphics[height=9cm]{../assets/demo-2}}
