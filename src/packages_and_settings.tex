...
\ctexset { subsection = {format={ \heiti \zihao {-4}} } } %设置各级系统的编号格式
\ctexset { subsubsection = {format={\heiti \zihao {-4}} } }          %
\ctexset { paragraph = {format={\heiti \zihao {-4}} } }               %
\ctexset { subparagraph = {format={\heiti \zihao {-4}} } }           %
...
\lhead{}                            %
\chead{\TitleCHS}                            %将页眉页脚设置为：仅在右下角显示页码
\rhead{}                            %
\lfoot{}                            %
\cfoot{\thepage}                            %
\rfoot{}                    %
...
\newtheorem{example}[theorem]{\heiti 例子}      %
\newtheorem*{example*}{\heiti 例子}             %
\newenvironment{solution}                       %
{\renewcommand\qedsymbol{$\blacksquare$}      %
    \begin{proof}[\heiti \textbf 解]}                 %
    {\end{proof}}                                 %
\renewcommand*{\proofname}{\heiti \textbf 证明}     %
...
\usepackage[title]{appendix} %提供了附录支持并显示在目录中
