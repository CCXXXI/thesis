...
% info 类用于输入论文信息
    info = {
        ...
        %
        keywords = {移动终端,可穿戴设备,动态心电图,深度学习},
        % 中文关键词
        % 请使用英文逗号 "," 以分隔
        %
        keywordsEN = {mobile terminal,wearable device,dynamic electrocardiogram,deep learning},
        % 英文关键词
        % 请使用英文逗号 "," 以分隔
        %
    },
% style 类用于简单设置论文格式
    style = {
        ...
        %   (默认选项为 lm )
        %
        declarePageResource = {../assets/declaration.pdf},
        % 扫描版声明页 PDF 文件
...
% 设置正文编号
    ...
    \include{chapters/req}
    \include{chapters/design}
    \include{chapters/dev}
